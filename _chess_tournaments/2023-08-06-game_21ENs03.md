...
In this tournament, you play one game with each opponent for a total of six games, 3 with White and 3 with Black. Send your first 
...
Description of Tournament 1.

### Game 1

Here you can embed the chess game using the embedded chess game example:
...
Here's another game for Tournament 1:

<div style="display: flex; justify-content: center;">
  <!-- Embed the second chess game here -->
</div>

<!-- Add more games for Tournament 1 if needed -->
